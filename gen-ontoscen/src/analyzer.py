...
class Analyzer:
    ...
    def _get_action(self, episode):
        ...
        matches = MATCHER(
            episode[self._getVerbPosition(episode) : e_length], as_spans=True
        )
    ...
    def analyze_for_actions(self, episode, actors, scenario) -> str:
    ...
    def analyze_for_actions(self, episode) -> List:
    ...
    def _get_resoruces_not_defined_in_scenario(
    ...
    def analyze_for_resources(
        ...
        resources_not_included = self._get_resoruces_not_defined_in_scenario(
            episode, resources
        )
